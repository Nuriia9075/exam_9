...
from accounts.views import RegisterView, UserDetailView, UserChangeView, UserPasswordChangeView, FavoriteListView
...
urlpatterns = [
    ...
    path('<int:pk>/favorite/', FavoriteListView.as_view(), name='favorite-list'),
